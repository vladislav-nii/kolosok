      ...
      "elements": [
       {
        ...
        "choices": [
         ...
         {
          "value": "Нежелание сотрудников использовать новые технологии на своих рабочих местах/участках",
          "text": {
           "ru": "Нежелание сотрудников использовать новые технологии на своих рабочих местах/участках"
          }
         },
         ...
         {
          "value": "Большое количество информационных систем, что значительно увеличивает трудоемкость отчетности",
          "text": {
           "ru": "Большое количество информационных систем, что значительно увеличивает трудоемкость отчетности"
          }
         }
        ],
